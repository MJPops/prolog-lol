...
PREDICATES
  	...
  	nondeterm поиск_все_ответы(ответ)
  	...
  	nondeterm оставить_уникальные_все_ответы(все_ответы, все_ответы, все_ответы)
ClAUSES
...
% следовательно, надо найти две разные гипотезы с одинаковым ответом С
  	...
  	поиск_уникальных_решений(УникальныеРешения):-
    		findall(Решение, поиск_все_ответы(Решение), Решения),
    		оставить_уникальные_все_ответы(Решения, [], УникальныеРешения).
    
  	оставить_уникальные_все_ответы([], Буфер, Множество):-
    	Множество = Буфер.
  	оставить_уникальные_все_ответы([ПервыйЭлемент|ОстальныеЭлементы], Буфер, Множество):-
		входит_в(ПервыйЭлемент, Буфер), 
		оставить_уникальные_все_ответы(ОстальныеЭлементы, Буфер, Множество).
  	оставить_уникальные_все_ответы([ПервыйЭлемент|ОстальныеЭлементы], Буфер, Множество):-
		NOT(входит_в(ПервыйЭлемент, Буфер)),
		оставить_уникальные_все_ответы(ОстальныеЭлементы, [ПервыйЭлемент|Буфер], Множество).
GOAL
