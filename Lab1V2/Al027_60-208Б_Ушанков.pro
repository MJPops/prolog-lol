...
% Гипотеза - то, какое мороженое любит Ирена
...
% По константам выставляются то, сколько мороженых не нравится частично
  nondeterm установить_число_неподходящих_мороженых_по_типу_ИЛИ_наполнителю(мороженое_ирены, множество_мороженых, integer)
% и сколько полностью
  nondeterm установить_число_неподходящих_мороженых_по_типу_И_наполнителей(мороженое_ирены, множество_мороженых, integer)

% Генерация гипотезы
  nondeterm определение_мороженого_ирены(мороженое_ирены)
% Проверка гипотезы
  nondeterm получение_мороженого_ирины(мороженое_ирены)
CLAUSES
  возможный_тип_мороженого(Тип) :-
    Тип = пломбир;
    Тип = шоколадное.
  ...
  определение_мороженого_ирены(мороженое_ирены(Тип, Наполнитель)) :-
    возможный_тип_мороженого(Тип),
    возможный_наполнитель(Наполнитель).
...
% В пустом списке нет неподходящего мороженого
  установить_число_неподходящих_мороженых_по_типу_ИЛИ_наполнителю(_, [], 0).
  установить_число_неподходящих_мороженых_по_типу_ИЛИ_наполнителю(МороженоеИрены, [Первое|Остальные], КоличествоНеподходящегоМороженого):-

    установить_число_неподходящих_мороженых_по_типу_ИЛИ_наполнителю(МороженоеИрены, Остальные, КоличествоОстальных),
  ...
  % То количество неподходящего мороженого увеличивается
    ...
    установить_число_неподходящих_мороженых_по_типу_ИЛИ_наполнителю(МороженоеИрены, Остальные, КоличествоНеподходящегоМороженого),
...
% В пустом списке нет неподходящего мороженого
  ...
  % Устанавливаем вид мороженого Ирины
    определение_мороженого_ирены(МороженоеИрены),
  % Находим все доступное мороженое
  ...
  % Устанавливается количество не нравящегося полностью или частично
    установить_число_неподходящих_мороженых_по_типу_ИЛИ_наполнителю(МороженоеИрены, МножествоМороженых, количество_мороженого_не_нравящегося_частично),
...
GOAL   
  получение_мороженого_ирины(Ирена_любит).