...
Predicates
	...
	nondeterm являются_парой(человек, человек)
...
%Гипотеза
	являются_парой(человек(Имя1, Пол1, Номер1), человек(Имя2, Пол2, Номер2) :-
		not(родственники(Имя1, Имя2), мужчина_выше(человек(_, Пол1, Номер1), человек(_, Пол1, Номер1)).
